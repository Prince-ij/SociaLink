...
import socialink.tasks

os.environ["ENV_STATE"] = "test"
import socialink
from socialink.database import database, users_table  # noqa E402
from socialink.main import app  # noqa: E402
...
print("HTTPX version in use:", AsyncClient.__module__)
...
async def created_post(async_client: AsyncClient, logged_in_token: str):
    return await create_post("Test body", async_client, logged_in_token)
...
def mock_httpx_client(mocker):
    mocked_client = mocker.patch("socialink.tasks.httpx.AsyncClient")
